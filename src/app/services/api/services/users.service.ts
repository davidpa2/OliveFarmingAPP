...
export class UsersService extends BaseService {
   ...
   * To access only the response body, use `apiUsersRegisterPost()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiUsersRegisterPost$Response(params?: {
   ...
   * To access the full response (for headers, for example), `apiUsersRegisterPost$Response()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiUsersRegisterPost(params?: {
    body?: UserRegisterDto
  },
  context?: HttpContext
    ...
    return this.apiUsersRegisterPost$Response(params,context).pipe(
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiUsersMeGet()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUsersMeGet$Response(params?: {
  },
  context?: HttpContext
  ...
  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apiUsersMeGet$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUsersMeGet(params?: {
  },
  context?: HttpContext

): Observable<void> {

    return this.apiUsersMeGet$Response(params,context).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
